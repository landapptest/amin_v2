...
class _ProfileViewState extends ConsumerState<ProfileView> with TickerProviderStateMixin {
  ...
  void _showProfileSheet(BuildContext context) {
    showModalBottomSheet(
      backgroundColor: ANIM_GREY_LIGHT,
      context: context,
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Divider(thickness: 1, height: 1, color: ANIM_GREY),
              ),
              SizedBox(height: 30),
              DropDownButton(
                ranges: languageRanges,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      width: 1,  // 선의 두께
                      height: 30,  // 선의 길이
                      color: ANIM_GREY,  // 선의 색상
                    ),
                    SizedBox(width:40),
                    CupertinoSwitch(
                      value: isGettingNotification,
                      activeTrackColor: ANIM_BLUE,
