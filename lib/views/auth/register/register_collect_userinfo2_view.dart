...
import 'package:chatting_1/views/auth/register/register_collect_userinfo3_view.dart';
...
class RegisterCollectUserInfoSecondScreen extends ConsumerWidget {
  const RegisterCollectUserInfoSecondScreen({super.key});
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            notifier.updateMyLanguage(index);
                            notifier.updateRegisterState(6);
                            AppRoutes.push(
                              context,
                              const RegisterCollectUserInfoThreeScreen(),
                            );
                          ...
                          child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  width: state.myLanguageIndex == index ? 3 : 0,
                                  color: state.myLanguageIndex == index ? Color(0xFF2A6EBB) : Colors.white.withAlpha(0x00), // colors is shown even width is 0
                                ),
                                color: Colors.white,
                                boxShadow: [
                                  BoxShadow(
